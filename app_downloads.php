...
<body>
		<div id="main_top">
			...
			<div id="main_top_right">
				...
				<a href="faq"><div id="menu_item">FAQ</div></a>
			</div>
		</div>
	...
	<div id="main"><br />
		<!--<div id="main_left">
		<img id="logo_profile" src="images/logo05.png" /><br /><br />
		<a href="apps/StudyItem_v1.0.jar" border="0px"><img src="images/download.png" />
		Mobile App Nokia, LG, Siemens...</a><br/><br/>
		<a href="apps/StudyItem_v1.0.apk"><img src="images/download.png">
		Mobile App HTC, Samsung...</a><br />
		</div>-->

		<div id="main_right" style="width: 630px; margin-left: 5px;">
		<a href="index.php" style="float: right"><h3>< Return</h3></a>
		<h3>StudyItem app downloads</h3>
			<p>To download StudyItem's mobile app click on the download link below or the appropriate download  button on your right.</p>

			<h3>Junior High School</h3>
			<p><a href="apps/StudyItem_v1.0.jar">StudyItem app for Nokia (JHS)</a><br />
			<a href="apps/StudyItem_v1.0.apk">StudyItem app for HTC, Samsung (JHS)</a></p><hr />
			<h3>Senior High School</h3>
			<p><a href="apps/StudyItem_SHS_v1.0.jar">StudyItem app for Nokia (SHS)</a><br />
			<a href="apps/StudyItem_SHS_v1.0.apk">StudyItem app for HTC, Samsung (SHS)</a></p>

		</div>

		<div id="main_sn" style="width: 210px">
